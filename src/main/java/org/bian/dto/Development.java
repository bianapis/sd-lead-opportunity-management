...
public class Development   {
  ...
  **/
  ...
  /**
   * `status: Provisionally Registered` bian-reference: SalesLeadManagement.SalesLead(as PartyRelationshipLifecyclePhase).PartyRelationship(as CustomerRelationship).Customer(as Role).Player(as Party).ContactPoint general-info: 'if customer contacted indirectly' 
