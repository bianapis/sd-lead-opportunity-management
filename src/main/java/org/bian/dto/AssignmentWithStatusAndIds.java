...
/**
 * AssignmentWithStatusAndIds
 */
public class AssignmentWithStatusAndIds   {
  private String leadOpportunityAssignmentReference = null;
  ...
  /**
   * `status: Provisionally Registered` bian-reference: SalesLeadManagement.SalesLead(as PartyRelationshipLifecyclePhase).PartyRelationship(as CustomerRelationship).Customer.RelationshipManager 
   * @return leadOpportunityAssignmentReference
  **/

  public String getLeadOpportunityAssignmentReference() {
    return leadOpportunityAssignmentReference;
  }

  public void setLeadOpportunityAssignmentReference(String leadOpportunityAssignmentReference) {
    this.leadOpportunityAssignmentReference = leadOpportunityAssignmentReference;
  }
  ...
  **/
  ...
  /**
   * `status: Provisionally Registered` bian-reference: SalesLeadManagement.SalesLead(as PartyRelationshipLifecyclePhase).PartyRelationship(as CustomerRelationship).Customer.RelationshipManager(as Role).ApplicablePeriod.FromDateTime general-info: 'date/time of update to the lead/opportunity' 
   * @return dateTime
  **/
